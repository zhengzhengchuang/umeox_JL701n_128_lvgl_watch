...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    widget_img_para.file_img_dat = find_00_index;
    widget_img_para.img_click_attr = false;
    widget_img_para.event_cb = NULL;
    lv_obj_t *find_dev_icon = common_widget_img_create(&widget_img_para, NULL);
    ...
    widget_label_para.label_text = get_lang_txt_with_id(lang_txtid_find_dev);
