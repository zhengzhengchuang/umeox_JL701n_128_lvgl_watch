...
static void menu_create_cb(lv_obj_t *obj)
{
    ...
    if(!lang_txt_is_arabic())
        tileview_register_all_menu(obj, ui_act_id_null, ui_act_id_null, \
            prev_act_id, ui_act_id_null, ui_act_id_tws_unpair);
    else
        tileview_register_all_menu(obj, ui_act_id_null, ui_act_id_null, \
            ui_act_id_null, prev_act_id, ui_act_id_tws_unpair);
...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    widget_label_para.label_text = get_lang_txt_with_id(lang_txtid_unpaired_tws);
