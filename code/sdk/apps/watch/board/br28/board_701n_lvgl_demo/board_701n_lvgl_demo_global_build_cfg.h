#ifndef CONFIG_BOARD_701N_LVGL_DEMO_POST_BUILD_CFG_H
#define CONFIG_BOARD_701N_LVGL_DEMO_POST_BUILD_CFG_H
 ...
 * 例如flash 16M，VM 128K，那么fat空间为16*1024*1024 - 128*1024 = 0xfe0000，
...
#define CONFIG_CHIP_NAME                        JL701N              //除了SDK发布者,请不要修改
//it can be modified before first programming,but keep the same as the original version
#define CONFIG_PID                              JL701N              //烧写或强制升级之前可以修改,之后升级要保持一致
//it can be modified before first programming,but keep the same as the original version
